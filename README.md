...
- **中文简介**：内置常见技能的中文一句话简介；未收录的技能自动回退显示 SKILL.md frontmatter 的 description
...
- **推荐插件**：面板与设置页内置照片显示器（dsh-chat-image-lightbox）、字体插件（dsh-font-enhancer）推荐位
- **DSH 设置页分区「悬浮球导航」**：在 DSH 设置中即可控制 🧩 技能球 / 🔤 字体球（若安装了字体插件）的显示与隐藏
